...
('Jallu', 'Opiskelijan herkku', 'Juo pois', 'http://t-mikomynt.users.cs.helsinki.fi/EeppinenDrinkkiarkisto/static/images/jallu.jpg', :Admin_id, now()),
('ullaJ', 'Salanimellinen mysteerijuoma', 'siop ouJ', 'http://t-mikomynt.users.cs.helsinki.fi/EeppinenDrinkkiarkisto/static/images/jallu.jpg', :Admin_id, now());
